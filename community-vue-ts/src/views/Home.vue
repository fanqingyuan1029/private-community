    ...
    <div class="home-container" ref="containerRef">
        <n-space vertical size="large">
            <n-layout style="height: 100%;">
                ...
                <!-- 页中 -->
                <n-layout-content style="height: calc(100vh - 150px);">
        ...
        <div v-if="route.path !== '/login'" style="position: absolute;z-index: 888;top: 20px;right: 20px;">
            <n-popover trigger="hover" v-if="store.userId === 0">
                <template #trigger>
                    <n-button @click="router.push({ name: 'Login' })">登陆</n-button>
                </template>
                <span>点此进入登录页</span>
            </n-popover>
